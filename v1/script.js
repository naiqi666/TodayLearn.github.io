...
async function loadFacts() {
  const res = await fetch(
    "https://eqelsesksdybzcilppao.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVxZWxzZXNrc2R5YnpjaWxwcGFvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDYyMjIwMjAsImV4cCI6MjAyMTc5ODAyMH0.IAseJRxdFOSY6BQjGxCY1PdHTjh2bxaUmc-FBqcpJiI",
      },
    }
  );
...
console.log(parseInt("25.533ccc"));
*/
...
//   if (age >= 0) return age;
//   else return `Impossibile year. Year needs to be less or equal ${currentYear}`;
// }

// const agel = calcFactAge(2015);
// console.log(agel);
...
if (votesInteresting === votesMindblowing) {
  alert("This fact is equally interesting and mindblowingh");
...
// const times9 = [2, 4, 6, 8].map(function(el){
//   return el* 10;
// });
